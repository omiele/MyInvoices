...
public class MainActivity extends AppCompatActivity {
  ...
  private void saveInvoice(){
    Intent intent = new Intent(MainActivity.this, SaveInvoiceActivity.class);
    startActivity(intent);
  }
  @Override
...
//    }
  public class SectionsPagerAdapter extends FragmentStatePagerAdapter {
    ...
    public Fragment getItem(int position) {
      ...
      switch (position) {
        case 0:
          FragmentInvoiceList regsFragment = FragmentInvoiceList.newInstance();
          return regsFragment;
    ...
    protected View getTabView(int position){
      switch (position) {
        case 0:
          ...
          tabTextView.setText("NEW");
          return tabView;
        case 1:
          tabView = LayoutInflater.from(MainActivity.this).inflate(R.layout.tab_custom_view, null);
          tabTextView = (TextView) tabView.findViewById(R.id.tab_name);
          tabTextView.setText("HELP");
          return tabView;
